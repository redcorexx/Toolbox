...
import { toFa, type ToastType } from "./lib/translator";
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-2 pt-12 text-center sm:px-6 sm:pt-16">
          ...
          >
            ...
            {toFa("۲۲")} زبان • ترجمه خودکار • ورودی صوتی
          </motion.div>
          <motion.h1
          ...
          >
            هر متنی را در یک چشم‌به‌هم‌زدن
            <span className="text-clay-500"> ترجمه </span>
            کن
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 22 }}
          ...
          >
            فارسی به انگلیسی و بالعکس، به‌علاوه بیش از {toFa("۲۰")} زبان دیگر —
            رایگان، بدون ثبت‌نام، با تاریخچه و تلفظ صوتی.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 22 }}
            animate={{ opacity: 1, y: 0 }}
