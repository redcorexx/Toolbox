...
export const dict = {
  ...
  /* ---------- چت با هوش مصنوعی ---------- */
  nav_chat: { fa: "چت", en: "Chat" },
  chat_title: { fa: "چت با هوش مصنوعی", en: "Chat with AI" },
  chat_subtitle: { fa: "با کلید اختصاصی خودت، مستقیم از مرورگر", en: "With your own API key, straight from your browser" },
  chat_no_key_title: { fa: "برای چت، اول کلید API لازم است", en: "Add an API key to start chatting" },
  chat_no_key_desc: {
    fa: "چت از همان کلید و مدلی استفاده می‌کند که در بخش «کلید اختصاصی» مترجم ذخیره کرده‌ای. یک کلید رایگان (مثلاً Groq یا Gemini) بگیر و آن‌جا وارد کن.",
    en: "Chat uses the same key and model you saved under “Your API key” in the translator. Grab a free key (e.g. Groq or Gemini) and enter it there.",
  },
  chat_setup_btn: { fa: "تنظیم کلید در مترجم", en: "Set up key in translator" },
  chat_empty_title: { fa: "سلام! چطور می‌تونم کمکت کنم؟", en: "Hi! How can I help you today?" },
  chat_empty_desc: { fa: "هر سؤالی داری بپرس؛ فارسی یا انگلیسی. مکالمه فقط در مرورگر خودت ذخیره می‌شود.", en: "Ask anything, in any language. The conversation is stored only in your browser." },
  chat_placeholder: { fa: "پیامت را بنویس… (Enter = ارسال، Shift+Enter = خط جدید)", en: "Type a message… (Enter = send, Shift+Enter = new line)" },
  chat_send: { fa: "ارسال", en: "Send" },
  chat_stop: { fa: "توقف", en: "Stop" },
  chat_thinking: { fa: "در حال فکر کردن…", en: "Thinking…" },
  chat_clear: { fa: "پاک کردن گفتگو", en: "Clear chat" },
  chat_clear_confirm: { fa: "مطمئنی؟ پاک کن!", en: "Sure? Clear!" },
  chat_copy_msg: { fa: "کپی پیام", en: "Copy message" },
  chat_regenerate: { fa: "پاسخ دوباره", en: "Regenerate" },
  chat_you: { fa: "تو", en: "You" },
  chat_stopped: { fa: "(متوقف شد)", en: "(stopped)" },
  chat_model_badge: { fa: "{provider} • {model}", en: "{provider} • {model}" },
  chat_change_model: { fa: "تغییر مدل", en: "Change model" },
  chat_suggest_1: { fa: "یک ایمیل رسمی برای درخواست مرخصی بنویس", en: "Write a formal email requesting time off" },
  chat_suggest_2: { fa: "تفاوت «را» و «رو» در فارسی چیست؟", en: "Explain the difference between “affect” and “effect”" },
  chat_suggest_3: { fa: "۵ ایده برای یادگیری سریع‌تر زبان انگلیسی", en: "5 tips to learn a new language faster" },
  n_chat_cleared: { fa: "گفتگو پاک شد", en: "Chat cleared" },
  n_chat_error: { fa: "پاسخی دریافت نشد؛ دوباره تلاش کن", en: "No response received; please try again" },
